...
sig nsd_topology_template extends TOSCA/TopologyTemplate
{
  ...
  // YAML vnf_vm1: {'type': 'tosca.nodes.nfv.VNF', 'requirements': [{'vl': 'vl1'}]}
  // ERROR: type tosca.nodes.nfv.VNF undefined
  // YAML vnf_vm2: {'type': 'tosca.nodes.nfv.VNF', 'requirements': [{'vl': 'vl1'}]}
  // ERROR: type tosca.nodes.nfv.VNF undefined
  // YAML vnf_container: {'type': 'tosca.nodes.nfv.VNF', 'requirements': [{'vl': 'vl2'}]}
  // ERROR: type tosca.nodes.nfv.VNF undefined
  ...
  // YAML ns_scaling_group: {'type': 'tosca.groups.Scaling', 'members': ['vnf_vm1', 'vnf_vm2', 'vnf_container'], 'properties': {'min_instances': 1, 'max_instances': 2}}
