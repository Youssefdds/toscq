...
sig tosca_datatypes_nfv_L2AddressData extends tosca_datatypes_Root
{
  ...
  // YAML mac_address_assignment: {'type': 'boolean', 'description': 'Specifies if the address assignment is the responsibility of management and orchestration function or not. If it is set to True, it is the management and orchestration function responsibility', 'required': True}
  //
...
sig tosca_datatypes_nfv_L3AddressData extends tosca_datatypes_Root
{
  ...
  // YAML ip_address_assignment: {'type': 'boolean', 'description': 'Specifies if the address assignment is the responsibility of management and orchestration function or not. If it is set to True, it is the management and orchestration function responsibility', 'required': True}
  //
  // Specifies if the address assignment is the responsibility of management and orchestration function or not. If it is set to True, it is the management and orchestration function responsibility
  //
  ip_address_assignment: one boolean,
...
//
// Represents an association relationship between the VduCp and VnfVirtualLink node types or the association between either a VnfExtCp, a PnfExtCp or a Sap and an NsVirtualLink node types.
//
