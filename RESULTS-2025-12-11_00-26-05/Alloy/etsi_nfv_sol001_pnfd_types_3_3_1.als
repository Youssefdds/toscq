...
sig tosca_nodes_nfv_PNF extends tosca_nodes_Root
{
  ...
  // YAML descriptor_invariant_id: {'type': 'string', 'required': True, 'description': 'Identifier of this PNFD in a version independent manner. This attribute is invariant across versions of PNFD.'}
  //
