...
sig tosca_datatypes_nfv_VirtualNetworkInterfaceRequirements extends tosca_datatypes_Root
{
  ...
  // YAML support_mandatory: {'type': 'boolean', 'description': 'Indicates whether fulfilling the constraint is mandatory (TRUE) for successful operation or desirable (FALSE).', 'required': True}
  //
...
//
// describes additional instantiation data for a given Vdu.Compute used in a specific deployment flavour.
//
sig tosca_datatypes_nfv_VduProfile extends tosca_datatypes_Root
{
  ...
  // YAML min_number_of_instances: {'type': 'integer', 'description': 'Minimum number of instances of the VNFC based on this Vdu.Compute that is permitted to exist for a particular VNF deployment flavour.', 'required': True, 'constraints': [{'greater_or_equal': 0}]}
  //
  ...
  // YAML max_number_of_instances: {'type': 'integer', 'description': 'Maximum number of instances of the VNFC based on this Vdu.Compute that is permitted to exist for a particular VNF deployment flavour.', 'required': True, 'constraints': [{'greater_or_equal': 0}]}
  //
...
sig tosca_datatypes_nfv_VnfConfigurableProperties extends tosca_datatypes_Root
{
  ...
  // YAML vnfm_interface_info: {'type': 'tosca.datatypes.nfv.VnfmInterfaceInfo', 'description': 'Contains information enabling access to the NFV-MANO interfaces produced by the VNFM (e.g. URIs and credentials), If the property is not present, then configuring this VNF property is not supported.', 'required': False}
  //
  ...
  //
  vnfm_interface_info: lone tosca_datatypes_nfv_VnfmInterfaceInfo,
...
//
sig tosca_datatypes_nfv_SwImageData extends tosca_datatypes_Root
{
  // --------------------------------------------------
  // Properties
  // --------------------------------------------------
  ...
  // YAML checksum: {'type': 'tosca.datatypes.nfv.ChecksumData', 'description': 'Checksum of the software image file', 'required': True}
  //
  // Checksum of the software image file
  //
  checksum: one tosca_datatypes_nfv_ChecksumData,
  ...
  // YAML disk_format: {'type': 'string', 'description': 'The disk format of a software image is the format of the underlying disk image', 'required': True, 'constraints': [{'valid_values': ['aki', 'ami', 'ari', 'iso', 'qcow2', 'raw', 'vdi', 'vhd', 'vhdx', 'vmdk']}]}
  //
  // The disk format of a software image is the format of the underlying disk image
  //
  disk_format: one string,

  // YAML min_disk: {'type': 'scalar-unit.size', 'description': 'The minimal disk size requirement for this software image', 'required': True, 'constraints': [{'greater_or_equal': '0 B'}]}
  //
  // The minimal disk size requirement for this software image
  //
  min_disk: one scalar_unit_size,
  ...
  // YAML size: {'type': 'scalar-unit.size', 'description': 'The size of this software image', 'required': True}
  //
  // The size of this software image
  //
  size: one scalar_unit_size,
  ...
  min_disk.greater_or_equal[0, B]
  some min_ram implies min_ram.greater_or_equal[0, B]

}

/** There exists some tosca.datatypes.nfv.SwImageData */
run Show_tosca_datatypes_nfv_SwImageData {
} for 5 but
  8 Int,
  5 seq,
  // NOTE: Setting following scopes strongly reduces the research space.
  ...
  exactly 0 TOSCA/Interface,
  exactly 0 TOSCA/Operation,
  exactly 1 tosca_datatypes_nfv_SwImageData
  expect 1
...
sig tosca_datatypes_nfv_VirtualFileStorageData extends tosca_datatypes_Root
{
  ...
  // YAML file_system_protocol: {'type': 'string', 'description': 'The shared file system protocol (e.g. NFS, CIFS)', 'required': True}
  //
...
sig tosca_datatypes_nfv_BootDataVimSpecificProperties extends tosca_datatypes_Root
{
  ...
  // YAML vim_type: {'type': 'string', 'description': 'Discriminator for the different types of the VIM information.', 'required': True}
  //
...
sig tosca_datatypes_nfv_VnfPackageChangeComponentMapping extends tosca_datatypes_Root
{
  ...
  component_type.valid_values["vdu" + "cp" + "virtual_link" + "virtual_storage" + "deployment_flavour" + "instantiation_level" + "scaling_aspect"]
...
//
// Represents an association relationship between Vdu.Compute and VduCp node types
//
...
//
// Represents an association relationship between the Vdu.Compute and one of the node types, Vdu.VirtualBlockStorage, Vdu.VirtualObjectStorage or Vdu.VirtualFileStorage
//
...
sig tosca_interfaces_nfv_Vnflcm extends tosca_interfaces_Root
{
  ...
  // YAML instantiate: {'description': 'Invoked upon receipt of an Instantiate VNF request'}
  //
  ...
  // YAML terminate: {'description': 'Invoked upon receipt Terminate VNF request'}
  //
  ...
  // YAML change_flavour: {'description': 'Invoked upon receipt of a Change VNF Flavour request'}
  //
  ...
  // YAML change_external_connectivity: {'description': 'Invoked upon receipt of a Change External VNF Connectivity  request'}
  //
  ...
  // YAML operate: {'description': 'Invoked upon receipt of an Operate VNF request'}
  //
  ...
  // YAML heal: {'description': 'Invoked upon receipt of a Heal VNF request', 'inputs': {'cause': {'type': 'string', 'description': 'Indicates the reason why a healing procedure is required.', 'required': False}, 'vnfc_instance_ids': {'type': 'list', 'entry_schema': {'type': 'string'}, 'description': 'List of VNFC instances requiring a healing action.', 'required': False}}}
  //
  ...
  // YAML scale: {'description': 'Invoked upon receipt of a Scale VNF request', 'inputs': {'type': {'type': 'string', 'description': 'Indicates the type of the scale operation requested.', 'constraints': [{'valid_values': ['scale_out', 'scale_in']}]}, 'aspect': {'type': 'string', 'description': 'Identifier of the scaling aspect.'}, 'number_of_steps': {'type': 'integer', 'description': 'Number of scaling steps to be executed.', 'required': True, 'constraints': [{'greater_than': 0}], 'default': 1}}}
  //
  ...
  // YAML create_snapshot: {'description': 'Invoked upon receipt of a Create VNF snapshot request'}
  //
  ...
  // YAML revert_to_snapshot: {'description': 'Invoked upon receipt of a Revert to VNF snapshot request'}
  //
  ...
  // YAML change_current_package: {'description': 'Invoked by tosca.policies.nfv.VnfPackageChange'}
  //
...
sig tosca_nodes_nfv_VNF extends tosca_nodes_Root
{
  ...
  // YAML monitoring_parameters: {'type': 'list', 'entry_schema': {'type': 'tosca.datatypes.nfv.VnfMonitoringParameter'}, 'description': 'Describes monitoring parameters applicable to the VNF.', 'required': False}
  //
  // Describes monitoring parameters applicable to the VNF.
  //
  property_monitoring_parameters: seq tosca_datatypes_nfv_VnfMonitoringParameter,
...
sig tosca_nodes_nfv_Vdu_Compute extends tosca_nodes_Root
{
  ...
  // YAML monitoring_parameters: {'type': 'list', 'description': 'Describes monitoring parameters applicable to a VNFC instantiated from this VDU', 'required': False, 'entry_schema': {'type': 'tosca.datatypes.nfv.VnfcMonitoringParameter'}}
  //
  // Describes monitoring parameters applicable to a VNFC instantiated from this VDU
  //
  property_monitoring_parameters: seq tosca_datatypes_nfv_VnfcMonitoringParameter,
  ...
  // YAML sw_image_data: {'type': 'tosca.datatypes.nfv.SwImageData', 'description': 'Defines information related to a SwImage artifact used by this Vdu.Compute node', 'required': False, 'status': 'deprecated'}
  //
  // Defines information related to a SwImage artifact used by this Vdu.Compute node
  //
  property_sw_image_data: lone tosca_datatypes_nfv_SwImageData,
...
sig tosca_nodes_nfv_Vdu_VirtualFileStorage extends tosca_nodes_Root
{
  ...
  // YAML virtual_storage: {'type': 'tosca.capabilities.nfv.VirtualStorage'}
  capability_virtual_storage: some tosca_capabilities_nfv_VirtualStorage,
...
sig tosca_nodes_nfv_VduCp extends tosca_nodes_nfv_Cp
{
  ...
  // YAML vnic_type: {'type': 'string', 'description': 'Describes the type of the virtual network interface realizing the CPs instantiated from this CPD', 'required': False, 'constraints': [{'valid_values': ['normal', 'macvtap', 'direct', 'baremetal', 'virtio-forwarder', 'direct-physical', 'smart-nic']}]}
  //
  ...
  // YAML virtual_binding: {'capability': 'tosca.capabilities.nfv.VirtualBindable', 'relationship': 'tosca.relationships.nfv.VirtualBindsTo', 'node': 'tosca.nodes.nfv.Vdu.Compute', 'occurrences': [1, 1]}
  requirement_virtual_binding: one TOSCA/Requirement,
  ...
  property_vnic_type.valid_values["normal" + "macvtap" + "direct" + "baremetal" + "virtio-forwarder" + "direct-physical" + "smart-nic"]
  ...
  requirement_virtual_binding.node[tosca_nodes_nfv_Vdu_Compute]
...
sig tosca_nodes_nfv_VnfVirtualLink extends tosca_nodes_Root
{
  ...
  // YAML monitoring_parameters: {'type': 'list', 'entry_schema': {'type': 'tosca.datatypes.nfv.VirtualLinkMonitoringParameter'}, 'description': 'Describes monitoring parameters applicable to the VL', 'required': False}
  //
  // Describes monitoring parameters applicable to the VL
  //
  property_monitoring_parameters: seq tosca_datatypes_nfv_VirtualLinkMonitoringParameter,
...
sig tosca_nodes_nfv_VipCp extends tosca_nodes_nfv_Cp
{
  ...
  // YAML target: {'capability': 'tosca.capabilities.Node', 'relationship': 'tosca.relationships.DependsOn', 'occurrences': [1, 'UNBOUNDED']}
...
//
// PlacementGroup is used for describing the affinity or anti-affinity relationship applicable between the virtualization containers to be created based on different VDUs, or between internal VLs to be created based on different VnfVirtualLinkDesc(s)
//
sig tosca_groups_nfv_PlacementGroup extends tosca_groups_Root
{
  ...
  members_type[tosca_nodes_nfv_Vdu_Compute + tosca_nodes_nfv_VnfVirtualLink]
}
...
sig tosca_policies_nfv_VduInstantiationLevels extends tosca_policies_Root
{
  ...
  // YAML targets: ['tosca.nodes.nfv.Vdu.Compute']
  targets_type[tosca_nodes_nfv_Vdu_Compute]
}
...
sig tosca_policies_nfv_AffinityRule extends tosca_policies_Placement
{
  ...
  // YAML scope: {'type': 'string', 'description': 'scope of the rule is an NFVI_node, an NFVI_PoP, etc.', 'required': True, 'constraints': [{'valid_values': ['nfvi_node', 'zone', 'zone_group', 'nfvi_pop', 'network_link_and_node']}]}
  //
  ...
  // YAML targets: ['tosca.nodes.nfv.Vdu.Compute', 'tosca.nodes.nfv.VnfVirtualLink', 'tosca.groups.nfv.PlacementGroup']
  targets_type[tosca_nodes_nfv_Vdu_Compute + tosca_nodes_nfv_VnfVirtualLink + tosca_groups_nfv_PlacementGroup]
}
...
sig tosca_policies_nfv_SupportedVnfInterface extends tosca_policies_Root
{
  ...
  // YAML interface_name: {'type': 'string', 'description': 'Identifies an interface produced by the VNF.', 'required': True, 'constraints': [{'valid_values': ['vnf_indicator', 'vnf_configuration']}]}
  //
  ...
  property_interface_name.valid_values["vnf_indicator" + "vnf_configuration"]
...
sig tosca_policies_nfv_SecurityGroupRule extends tosca_policies_nfv_Abstract_SecurityGroupRule
{
  ...
  // YAML targets: ['tosca.nodes.nfv.VduCp', 'tosca.nodes.nfv.VnfExtCp']
  targets_type[tosca_nodes_nfv_VduCp + tosca_nodes_nfv_VnfExtCp]
}
...
sig tosca_policies_nfv_VnfPackageChange extends tosca_policies_Root
{
  ...
  // YAML selector: {'type': 'tosca.datatypes.nfv.VnfPackageChangeSelector', 'description': 'Information to identify the source and destination VNFD for the change, and the related deployment flavours.', 'required': True}
  //
  // Information to identify the source and destination VNFD for the change, and the related deployment flavours.
  //
  property_selector: one tosca_datatypes_nfv_VnfPackageChangeSelector,
