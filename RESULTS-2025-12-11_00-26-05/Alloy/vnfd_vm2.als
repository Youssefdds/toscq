...
sig vnfd_vm2_topology_template extends TOSCA/TopologyTemplate
{
  // --------------------------------------------------
  // YAML node_templates:
  // --------------------------------------------------

  // YAML vm2: {'type': 'tosca.nodes.nfv.VDU', 'properties': {'descriptor_id': 'vm2-desc', 'descriptor_version': 1.0, 'provider': 'ExampleProvider', 'product_name': 'vm2', 'software_version': 1.0, 'vnfm_info': 'vnfm_vm2', 'flavour_id': 'small', 'flavour_description': '1 vCPU, 2GB RAM'}}
  ...
  // YAML scaling_group_vm2: {'type': 'tosca.groups.Scaling', 'properties': {'min_instances': 1, 'max_instances': 3}}
  // YAML type: tosca.groups.Scaling
  group_scaling_group_vm2: one tosca_groups_Scaling,
  ...
  node[vm2]
  vm2.name["vm2"]
  vm2.node_type_name = "tosca.nodes.nfv.VDU"
  // YAML properties:
  // YAML interfaces:
  no vm2.interfaces
  // YAML artifacts:
  ...
  #groups = 1
  // YAML scaling_group_vm2: {'type': 'tosca.groups.Scaling', 'properties': {'min_instances': 1, 'max_instances': 3}}
  group[group_scaling_group_vm2]
  group_scaling_group_vm2.name["scaling_group_vm2"]
  // YAML properties:
  // YAML min_instances: 1
  group_scaling_group_vm2.property_min_instances = 1
  // YAML max_instances: 3
  group_scaling_group_vm2.property_max_instances = 3
  // YAML interfaces:
  #group_scaling_group_vm2.interfaces = 1
  // YAML Standard:
  // YAML create: {'description': 'Standard lifecycle create operation.'}
  no group_scaling_group_vm2.interface_Standard.operation_create.implementation
  no group_scaling_group_vm2.interface_Standard.operation_create.inputs
  // YAML configure: {'description': 'Standard lifecycle configure operation.'}
  no group_scaling_group_vm2.interface_Standard.operation_configure.implementation
  no group_scaling_group_vm2.interface_Standard.operation_configure.inputs
  // YAML start: {'description': 'Standard lifecycle start operation.'}
  no group_scaling_group_vm2.interface_Standard.operation_start.implementation
  no group_scaling_group_vm2.interface_Standard.operation_start.inputs
  // YAML stop: {'description': 'Standard lifecycle stop operation.'}
  no group_scaling_group_vm2.interface_Standard.operation_stop.implementation
  no group_scaling_group_vm2.interface_Standard.operation_stop.inputs
  // YAML delete: {'description': 'Standard lifecycle delete operation.'}
  no group_scaling_group_vm2.interface_Standard.operation_delete.implementation
  no group_scaling_group_vm2.interface_Standard.operation_delete.inputs
  #group_scaling_group_vm2.interface_Standard.operations = 5
  // YAML members: None
  no group_scaling_group_vm2.members
...
/** There exists some vnfd_vm2_topology_template */
run Show_vnfd_vm2_topology_template {
} for 0 but
  ...
  exactly 1 vnfd_vm2_topology_template,
